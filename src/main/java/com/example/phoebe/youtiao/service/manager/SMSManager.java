...
public class SMSManager {
    ...
    final int templateId = 316933;
    final String smsSign = "205183";
    public boolean sendSMS(String phone, String timeStr, String name){
        try {
            String[] params = {timeStr, "\""+ name + "\""};//数组具体的元素个数和模板中变量个数必须一致，例如事例中templateId:5678对应一个变量，参数数组中元素个数也必须是一个
